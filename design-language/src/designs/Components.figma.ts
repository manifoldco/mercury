...
const componentsTypography = {
    headingLarge: new Typograph({ fontSize: 25, color: Color.rgba(0, 0, 0, 1), font: componentsFonts.SfProText.Regular }),
    body: new Typograph({ fontSize: 16, color: Color.rgba(87, 91, 95, 1), font: componentsFonts.SfProText.Regular }),
    label: new Typograph({ fontSize: 14, color: Color.rgba(247, 247, 248, 1), font: componentsFonts.SfProText.Regular }),
    caption: new Typograph({ fontSize: 12, color: Color.rgba(255, 255, 255, 1), font: componentsFonts.SfProText.Regular })
};
