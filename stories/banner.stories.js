  ...
  <Story>
    <Demo>
      <div role="alert" className="Manifold__Banner">
        <div className="Manifold__BannerIcon">
          <svg
            aria-label="info"
            role="img"
            viewBox="0 0 24 24"
        ...
        Generic information uses a basic message bar.
      </div>
    </Demo>
    <Description>
      <h1>Default</h1>
      <p>The default banner surfaces info to the user without any urgency. Use it to give context about an action.</p>
    </Description>
    <Code
      tabs={{
        html: `<!-- banner -->
<div class="Manifold__Banner">
  Default banner
</div>`,
  ...
  <Story>
    <Demo>
      <div role="alert" className="Manifold__Banner Manifold__Banner--Error">
        ...
        Uh oh, something is wrong. Please review the wrong thing.
      </div>
    </Demo>
    <Description>
      <h1>Error</h1>
    ...
    <Code
      tabs={{
        html: `<!-- banner -->
<div class="Manifold__Banner--Error">
  Uh oh, something is wrong. Please review the wrong thing.
</div>`,
        scss: `${comment.block(title)}
  ...
  <Story>
    <Demo>
      <div role="alert" className="Manifold__Banner Manifold__Banner--Success">
        ...
        Look at that! An absolute success, nice work.
      </div>
    </Demo>
    <Description>
      <h1>Success</h1>
    ...
    <Code
      tabs={{
        html: `<!-- banner -->
<div class="Manifold__Banner--Success">
  Uh oh, something is wrong. Please review the wrong thing.
</div>`,
        scss: `${comment.block(title)}
...
export const warning = () => (
  <Story>
    ...
    <Code
      tabs={{
        html: `<!-- banner -->
<div class="Manifold__Banner--Warning">
  Uh oh, something is wrong. Please review the wrong thing.
</div>`,
        scss: `${comment.block(title)}
