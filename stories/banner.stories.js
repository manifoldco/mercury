...
export const defaultBanner = () => (
  <Story>
    ...
    <Code
      tabs={{
        html: `<div role="alert" className="Manifold__Banner">
...
export const error = () => (
  <Story>
    ...
    <Code
      tabs={{
        html: `<div role="alert" className="Manifold__Banner Manifold__Banner--Error">
...
export const success = () => (
  <Story>
    ...
    <Code
      tabs={{
        html: `<div role="alert" className="Manifold__Banner Manifold__Banner--Success">
...
export const warning = () => (
  <Story>
    ...
    <Code
      tabs={{
        html: `<div role="alert" className="Manifold__Banner Manifold__Banner--Warning">
